...
var definitions = {
    ...
    "UndirectedGraphNode":"/** \n * Definition for undirected graph.\n *\t function UndirectedGraphNode(x) {\n *\t this.label = x;\n *\t this.neighbors = [];\n * }\n */\n",
    "DirectedGraphNode": "",
...
router.get('/api/problems/:problem',function(req,res,next) {

    var param = req.param('problem')
    console.log(param)
    param = param.toLowerCase()
    var code = {}
    code.snippet = "";
    if (codeSupplement[param].extra) {
        console.log(codeSupplement[param].extra);
        var extras = codeSupplement[param].extra.split(',');
        for (var i = 0; i<extras.length; i++) {
            code.snippet += definitions[extras[i]]===undefined?"":definitions[extras[i]];
        }
    }
    code.snippet += codeSupplement[param].snippet;
    code.functionName = codeSupplement[param].functionName;
    code.parameters = codeSupplement[param].params;
    code.returnType = codeSupplement[param].returnType;
    code.order = codeSupplement[param].order;
    code.inPlace = codeSupplement[param].inPlace;
    res.json(code)

})


router.post('/api/problems/:problem',function(req,res,next) {
